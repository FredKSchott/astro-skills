...
```
# Host skills from your Astro site, let your users do this:
npx skills add https://your-website-here.com/
```

Load and serve [Agent Skills](https://agentskills.io/) from your Astro site via well-known URIs. This integration implements the [Agent Skills Discovery RFC](https://github.com/elithrar/agent-skills-discovery-rfc), allowing AI agents to discover and use skills published on your website. 
